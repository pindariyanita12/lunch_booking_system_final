...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ url('/user/welcome') }}"><img
                    src="{{ url('/Images/simform_logo.png') }}" width="170px" height="70px" class="img-fluid"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="link">
                    <li class="nav-item">
                        ...
                        <a class="nav-link" aria-current="page" href="{{ url('/user/welcome') }}">Home</a>
                    </li>
                    <li class="nav-item">
