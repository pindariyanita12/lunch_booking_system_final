    ...
    <div class="container">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle " data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Employee Monthwise</a>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="tab2">
                ...
                <!-- <form action='#tab2' id="tab2" method="get"> -->
                <select name="id" style="cursor: Pointer;" class="form-select form-select-sm-1  text-black border-0" id="idis">
